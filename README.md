...
If you cloned the repository or have Python installed:
1. Double-click **`Start-Aibou.bat`** (or run `python desktop_launcher.py`).
2. The launcher automatically starts the local backend and opens the native desktop app window!
...
- **Node.js 18+** & npm
- **Ollama** ([ollama.com](https://ollama.com)): Make sure to pull whichever local model you want to run.
...
# Recommended local model for 16GB VRAM (50+ tokens/sec)
ollama pull qwen2.5:14b

# Lightweight models for any laptop or low-spec PC:
